...
export default function StickySocials() {
  ...
  return (
    <div className="sticky-socials-container">
      <div className={`sticky-socials-wrapper ${isOpen ? 'open' : ''}`}>
        
        <div className="social-links-drawer">
          <a 
            href="https://www.facebook.com/profile.php?id=61570998157919&mibextid=ZbWKwL" 
            className="sticky-icon fb-sticky" 
            target="_blank" 
          ...
          >
            ...
            <span className="sticky-tooltip">Facebook</span>
          </a>
          <a 
            href="https://instagram.com/solveria4?utm_source=qr&igsh=MXJxY2xsaHU2Nzdwcw==" 
            className="sticky-icon ig-sticky" 
            target="_blank" 
            rel="noopener noreferrer" 
          ...
          >
            ...
            <span className="sticky-tooltip">Instagram</span>
          </a>
          <a 
            href="https://wa.me/201288979593" 
            className="sticky-icon wa-sticky" 
            target="_blank" 
            rel="noopener noreferrer" 
            aria-label="WhatsApp"
          >
            ...
            <span className="sticky-tooltip">WhatsApp</span>
          </a>
        </div>

        <button 
          className="sticky-toggle-btn glow-effect"
